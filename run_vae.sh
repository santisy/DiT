...
#SBATCH --job-name="vae_0511_l1_chairs_VQ"
...
# Copy data to local
WORK_DIR=$(pwd)
DATA_ZIP_PATH=./datasets/shapenet_chairs_l_corrected.zip
...
train_vae.py --exp-id vae_0511_l1_chairs_VQ \
    --epoch 2000 \
    --global-batch-size 48 \
    --config-file configs/OFALG_config_v9_nl_small.yaml \
    --data-root ${SLURM_TMPDIR}/shapenet_chairs_l_corrected \
    --num-workers 24 \
    --ckpt-every 10000 \
    --level-num 1 \
    --work-on-tmp-dir
