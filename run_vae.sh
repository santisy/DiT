...
# Copy data to local
WORK_DIR=$(pwd)
DATA_ZIP_PATH=/home/dya62/scratch/datasets/shapenet_chairs.zip
...
train_vae.py --exp-id vae_0421_02 \
    --epoch 2000 \
    --global-batch-size 24 \
    --config-file configs/OFALG_config_v5.yaml \
    --data-root ${SLURM_TMPDIR}/shapenet_chairs \
    --num-workers 24 \
    --ckpt-every 10000 \
    --work-on-tmp-dir
